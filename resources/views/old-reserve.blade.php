...
@section('content')
    <finder heading="Let's make a reservation" submit-url="{{ url('rooms') }}" ref="finder">
        ...
        <div class="form__input-wrapper form__input-wrapper--submit">
            <a href="{{ url('dashboard') }}" class="btn btn--fourthiary">Search for a workplace</a>
        </div>
    </finder>
        ...
        <div class="rooms__wrapper flex">
            <div class="rooms flex">
                @foreach ($rooms as $room)
                    <a href="#" class="rooms__item box flex"> <!-- rooms__item--selected -->
            ...
            <div class="rooms__detailed box">
                <div class="rooms__info flex">
                    ...
                    <div class="rooms__info-right">
                        <a href="#" class="btn btn--thirdiary">Reserve</a>
                ...
                <canvas class="rooms__placing" width="1000" height="500">
                    <!--
