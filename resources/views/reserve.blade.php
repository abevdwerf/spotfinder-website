...
@section('content')
    @if (Auth::Check())
        <finder type="reservate" heading="Let's place an reservation" submit-url="{{ url('allRooms') }}" reservate-url="{{ url('newReservation') }}" get-reservations-url="{{ url('reservations') }}" ref="finder">
        ...
        <main @if(count($reservations) > 0) class="tab__wrapper" @endif>
            @if(count($reservations) > 0)
                <div class="tab__navigator">
                    <a href="#" class="tab__navigator__item tab__navigator__item--active" v-on:click.prevent="tabChange($event, 'reserve')">
                        Reserve
                    </a>

                    <a href="#" class="tab__navigator__item" v-on:click.prevent="tabChange($event, 'reservations')">
                        My reservations
                    </a>
                </div>
            @endif
            ...
            <div class="tab__item" data-reserve>
