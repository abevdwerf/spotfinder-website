...
@section('content')
    <section class="finder">
        ...
        <h1 class="h1">Laten we een werkplek zoeken</h1>
        ...
        <form action="./" method="post" class="finder__form form">
            ...
            <div class="form__input-wrapper form__input-wrapper--submit">
                <input type="submit" class="btn btn--thirdiary" value="Find workspace">
            </div>
            ...
            <div class="form__input-wrapper form__input-wrapper--submit">
                <a href="./" class="btn btn--fourthiary">Make an reservation</a>
            </div>
        </form>
    </section>
    ...
    <main>
        ...
        <div class="reservations flex">
            <div class="reservation__item box">
                <span class="reservation__location">Fontys R10, Rachelsmolen</span>
                <div class="flex" style="justify-content: flex-start;">
                    <h4 class="h4">OIL 0.12</h4>
