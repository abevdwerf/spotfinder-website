        ...
        <div class="dashboard__search-result">
            ...
            <div class="dashboard__content-wrap flex">
                <div class="dashboard__search-inner">
                    <div v-for="room in rooms" :key="room.id" class="rooms__item rooms__item--extended box flex" v-on:click="roomToggle(room)">
                        <div class="flex">
                ...
                <div class="dashboard__search-detailed" v-if="room != null">
                    <div class="rooms__detailed box">
                        ...
                        <canvas-grid ref="canvas" class="rooms__placing" ></canvas-gr>
                    </div>
                </div>
            </div>
        </div>
