...
@section('content')
    <section class="finder">
        ...
        <h1 class="h1">Let's make a reservation</h1>

        <form action="{{url('reservate')}}" method="post" class="finder__form form">
            <div class="form__input-wrapper">
                <label class="form__label flex" for="finder-location">
                    <svg xmlns="http://www.w3.org/2000/svg" width="11.667" height="16.667" viewBox="0 0 11.667 16.667">
                        <path d="M10.833,2A5.829,5.829,0,0,0,5,7.833c0,4.375,5.833,10.833,5.833,10.833s5.833-6.458,5.833-10.833A5.829,5.829,0,0,0,10.833,2Zm0,7.917a2.083,2.083,0,1,1,2.083-2.083A2.084,2.084,0,0,1,10.833,9.917Z" transform="translate(-5 -2)" />
                    </svg>
            ...
            <div class="form__input-wrapper">
                ...
                <input id="finder-date" class="form__input form__input--date" type="date">
            </div>
            ...
            <div class="form__input-wrapper">
                ...
                <div class="flex">
                    <input id="finder-begin-time" class="form__input form__input--date" type="time">
                    <input id="finder-begin-end" class="form__input form__input--date" type="time">
                </div>
            </div>

            <div class="form__input-wrapper form__input-wrapper--submit">
                <input type="submit" class="btn btn--thirdiary" value="Search">
            </div>
        </form>
    </section>

    <main>
        <h2 class="h1">Available spaces</h2>
            ...
            <div class="rooms__detailed box">
                <div class="rooms__info flex">
                    ...
                    <div class="rooms__info-right">
                        <a href="#" class="btn btn--thirdiary">Reservate</a>
                        <p>Today: 13:00 - 14:00</p>
                    </div>
                </div>
