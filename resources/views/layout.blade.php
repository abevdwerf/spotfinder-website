            ...
            <section class="navigation flex" v-bind:class="navigationActive ? 'navigation--active' : ''">
                ...
                <nav class="navigation__nav">
                    ...
                    <ul class="navigation__list">
                        ...
                        @if (Auth::Check())
                            <a href="{{ url("reserve") }}" class="navigation__list-link @if ($page === "Reserve") navigation__list-link--active @endif flex">
                                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill-rule="evenodd" clip-rule="evenodd"> <path d="M14 0v10l2-1.518 2 1.518v-10h4v24h-17c-1.657 0-3-1.343-3-3v-18c0-1.657 1.343-3 3-3h9zm6 20h-14.505c-1.375 0-1.375 2 0 2h14.505v-2z" /> </svg>
                                <li class="navigation__list-item">Reserve</li>
                            </a>
                        @endif

                        <a href="{{ url("about-us") }}" class="navigation__list-link @if ($page === "About us") navigation__list-link--active @endif flex">
                            ...
                            <li class="navigation__list-item">About us</li>
                        </a>

                        <a href="{{ url("contact") }}" class="navigation__list-link @if ($page === "Contact") navigation__list-link--active @endif flex">
                            ...
                            <li class="navigation__list-item">Contact</li>
                        </a>
                        ...
                        <a href="{{ url("reservatie-lijst") }}" class="navigation__list-link flex">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"> <path d="M19 11h-14v-2h14v2zm0 2h-14v2h14v-2zm0 4h-14v2h14v-2zm3-11v16h-20v-16h20zm2-6h-24v24h24v-24z" /> </svg>
                ...
                <div class="navigation__buttons">
                    ...
                    @else <a href="{{ url('logout') }}" class="btn">Sign out</a> @endif
                </div>
            </section>
